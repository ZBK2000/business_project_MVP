...
import RatingSlide from "../small_components/ratingSlider";

import Button from "@mui/material/Button";

import Players from "../small_components/players";
...
//-----------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  bottom: "45%", fontSize:"45px", color:"#f5f5f5", "&:hover":{ fontSize:"50px", color:"#d1d1d1"}}} />
      ...
      <Typography variant="h5" sx={{margin:{md:"10px 0px 10px",xs:"10px"}, width:"300px"}}>Choose a Date </Typography>
     {/* <Next7DaysDropdown getUpData={setRightDay} />*/} 
      <StaticDatePickerLandscape getUpData={setRightDay} />
      <Box display={"flex"} flexDirection={{xs:"column", md:"row"}}  sx={{height:{md:"60%"}}} justifyContent={{md:"space-between", xs:"center"}} alignItems={"center"}>

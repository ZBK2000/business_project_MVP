...
export default function UserRegisterWithFirebase(props) {
  ...
  return (
    ...
    >
          ...
          <div>
                ...
                <Grid>
                  ...
                  >
                    ...
                    <Typography
                      ...
                      variant="h7"
                    >
                      Sign up now and join others in various activities
                    </Typography>
                    <Button
                    ...
                    >
                      ...
                      />
                      <Typography margin={"10px"} sx={{ color: "#d6d6d6" }}>
                        OR
                      </Typography>
                      <hr
                        style={{
            ...
            {rigthPassword && (
              <Typography
                ...
                className="success"
              >
                Not powerful enough password (please provide at least 6
                characters)
              </Typography>
            )}
            {error && (
      ...
      {provideUserName && (
        <ProvideUserName
          indicator={setProvideUserName}
          indicator2={props.indicator}
        />
      )}
    </Box>
  );

...
const count = linkData?.slots? linkData.slots.reduce((acc, curr) => {
  ...
  return (<Grid>
    ...
    <Grid sx={{ 
        ...
        <Typography  variant="h4" component="h1" gutterBottom sx={{ marginTop: '10px', marginBottom:"0px",width:"fit-content" }}>
         {linkData.trackName} 
        </Typography>

        <Box sx={{backgroundColor:"#C8C6C6", borderRadius:"10px", padding:"10px", display:"flex",justifyContent:"space-between", gap:6, boxShadow:'10px  black'}}>
          <Box sx={{backgroundColor:"#dbdbdb", borderRadius:"10px", padding:"10px", display:"flex", gap:6, color:"grey"}}>
          <Box>
  ...
  <Box sx={{ display: "grid", gridTemplateColumns: "120px auto", gap: 6 }}>
    ...
    <Typography variant="h6" component="h1" gutterBottom>
      ...
      {linkData.user}
        ...
        <Box display={{md:"flex"}}>
        <Box sx={{borderRadius:"10px", padding:"20px",paddingTop:"5px",border: '1px solid #dbdbdb', width:{md:"50%"}, overflow:"auto", height:"300px"}}>
...
<Box  justifyContent={"space-between"} sx={{display:"flex", flexDirection:{md:"row", xs:"column"}, alignItems:"center"}}>
        <Box className="element" sx={{border: '1px solid #dbdbdb', borderRadius:"10px", width:{md:"50%", xs:"80%"}, height:"300px", overflow:"auto", margin:"10px 10px 10px 0px"}}>
          <Typography variant='h5' sx={{margin:"20px"}}>Participants <span className='gradient-heading2' style={{borderRadius:"10px", padding:"4px"}}>{linkData.isLimited?`${count} place remaining`:"Unlimited"}</span></Typography>
        <List sx={{ listStyle: 'none', margin: '0', padding: '0', maxHeight:"220px", overflow:"auto", width:"100%", borderTop:"1px solid #dbdbdb"}}>
          { liSlotsList }
        </List>
